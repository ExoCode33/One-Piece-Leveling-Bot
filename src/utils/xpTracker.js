...
module.exports = XPTracker;// src/utils/xpTracker.js - Complete fixed file with XP boost integration and proper voice handling + USER PING TOGGLE + EARLY LEVEL PENALTY
