// Add this method to your XPTracker class in xpTracker.js

const { createCanvas, loadImage, registerFont } = require('canvas');
const { AttachmentBuilder, EmbedBuilder } = require('discord.js');

// Add this inside your XPTracker class
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields([
                ...
                },
                {
                    ...
                    value: `**Previous Bounty:** ${oldBounty.toLocaleString()} <:berry:1234567890> Berries\n**New Bounty:** ${newBounty.toLocaleString()} <:berry:1234567890> Berries\n**Increase:** +${bountyIncrease.toLocaleString()} <:berry:1234567890> Berries`,
                    inline: true
                },
                {
            ...
            .setFooter({ 
                ...
                iconURL: 'https://i.imgur.com/marine_logo.png' 
            });
...
// Helper method to create level-up poster
async createLevelUpPoster(wantedPosterData) {
    const canvas = createCanvas(800, 1000);
    const ctx = canvas.getContext('2d');

    try {
        // Load and draw scroll background
        const scrollBg = await loadImage('https://i.imgur.com/scroll_texture.jpg'); // Replace with your scroll texture
        ctx.drawImage(scrollBg, 0, 0, 800, 1000);
    } catch (error) {
